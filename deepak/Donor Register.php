...
if(isset($_POST['submit'])) {
 ...
 $query = "INSERT INTO donor(username,email,password)values('{$name}','{$email}','{$password}')";
...
// 	session_start();
	...
	echo "<script type='text/javascript'>document.location='Donor login.php';</script>";
// }
// else {
...
?>
	...
	<div class="card login-form">
		<div class="card-body">
			<h3 class="card-title text-center"><center><h1 style="color:black;"><u>Donor Register Page</u></h1></center></h3>
			<div class="card-text">
				<!--
				...
				<form method="POST" action="">
					...
					<p class="account-w3ls text-center pb-4" style="color:#000">
                                    Already registered?
                                    <a href="Donor login.php" >Login here</a>
                                </p>
				</form>
			   </div>
		      </div>
