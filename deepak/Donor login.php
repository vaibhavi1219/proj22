...
$query = "SELECT * FROM donor WHERE username = '{$name}' AND password = '{$password}'";
...
if (mysqli_num_rows($result) != null )
{
	...
	echo "<script type='text/javascript'>document.location='Donor user.php';</script>";
}
else {
...
?>
	...
	<div class="card login-form">
		<div class="card-body">
			<h3 class="card-title text-center"><center><u style="color:black;">Donor Login</u></center></h3>
			<div class="card-text">
				<!--
				...
				<form method="POST" action="">
					...
					<p class="account-w3ls text-center pb-4" style="color:#000">
                                    ...
                                    <a href="Donor Register.php" >Register here</a>
                                </p>
				</form>
			   </div>
		      </div>
